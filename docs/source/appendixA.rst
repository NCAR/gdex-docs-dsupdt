...
- :ref:`A.8. Info Option -PD (-PatternDelimiter): When a local file name contains '<P0>.txt', the replacement value for '<P0>' must be the first -GP value; omitting it causes a fatal error. Additional patterns (<P1>, <P2>, ...) are provided as subsequent -GP values. <5.2_e8>`
